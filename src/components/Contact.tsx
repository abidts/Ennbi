            ...
            <div className="bg-blue-50 p-8 rounded-lg h-full">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.instagram.com/ennbi_softwares?igsh=bm9qcWo4d3pucjRv&utm_source=qr" className="bg-blue-100 p-3 rounded-full text-blue-900 hover:bg-blue-200 transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
