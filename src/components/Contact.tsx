...
const Contact: React.FC = () => {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-gray-700">
            Ready to start your next project? Get in touch with our team to discuss how we can help bring your ideas to life.
          </p>
        </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg h-full">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.instagram.com/?hl=en" className="bg-blue-100 p-3 rounded-full text-blue-900 hover:bg-blue-200 transition-colors duration-300">
  ...
  className="bg-blue-100 p-3 rounded-full text-blue-900 hover:bg-blue-200 transition-colors duration-300"
>
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 2.163c3.204 0 3.584.012 4.85.07..." />
                  ...
                  <a href="#" className="bg-blue-100 p-3 rounded-full text-blue-900 hover:bg-blue-200 transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
